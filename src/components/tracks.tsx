...
export default function Tracks() {
  return (
    <div className=" flex-col mt-2 lg:mt-0 md:flex-row lg:flex-col h-full max-h-[calc(100vh-5.5rem)]">
      <aside className="w-full px-0 scrollbar-hide h-full overflow-y-auto bg-[#F7F3F0] border-4 border-black rounded-2xl">
        ...
        <div className="p-4  lg:grid lg:grid-flow-row  flex md:grid-flow-row gap-4">
